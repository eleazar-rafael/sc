<div class="panel panel-primary">
    <div class="panel-heading">
        ...
        <div class="pull-right">            
            <?php echo anchor("cat/convenio/insert",'<span class="glyphicon glyphicon-plus-sign"></span>  Agregar','class="btn btn-primary "')?> 
        </div>
        <div style="clear: both;"></div>
    </div>
    <?php echo form_open("cat/convenio/index","id='form'")?>
    ...
    <thead>
        <tr >
            ...
            <th width="110">
                <?php $class_order = ($sort == 'fecha_firma_del_convenio')? strtolower($order): ""?>
                <a href="<?php echo $sort_fecha_firma_del_convenio; ?>" class="<?php echo $class_order?>">Fecha firma<br> del convenio</a>
            </th>   
            <th width="110">
            ...
            <th>
                ...
                <a href="<?php echo $sort_frecuencia_pagos; ?>" class="<?php echo $class_order?>">Frecuencia<br>de pagos</a>
            </th>
            <th>
                <?php $class_order = ($sort == 'canal')? strtolower($order): ""?>
                <a href="<?php echo $sort_canal; ?>" class="<?php echo $class_order?>">Canal</a>
            </th>
            <th width="16" ></th>
            <th width="16" ></th>
            <th width="16" ></th>
    ...
    <tbody>
        ...
        <tr >
            ...
            <td align="center"><input type="text" name="filter[fecha_firma_del_convenio]" value="<?php echo $filter['fecha_firma_del_convenio']?>" style="width:95%"></td>
            ...
            <td align="center"><input type="text" name="filter[canal]" value="<?php echo $filter['canal']?>" style="width:95%"></td>
    ...
    <?php if($arrInfo):?>
        <?php foreach($arrInfo as $pos => $row):?>
            <tr>
                ...
                <td align="center"><?php echo $row['fecha_firma_del_convenio']?></td>
                ...
                <td ><?php echo $row['canal_nombre']?></td>
                <td><?php echo anchor("cat/convenio/update/?id=".$row['id'], '<span class="glyphicon glyphicon-edit"></span>','title="Editar Registro" class="btn btn-primary btn-xs"') ?></td>
                <td><?php echo anchor("cat/convenio_calendario/index/?convenio_id=".$row['id'], '<span class="glyphicon glyphicon-calendar"></span>','title="Editar Registro" class="btn btn-primary btn-xs"') ?></td>
...
<script type="text/javascript"><!--
    ...
    function borrar(id){
        if(confirm('Desea borrar el registro seleccionado?')){
            location = '<?php echo site_url("cat/convenio/delete/?id=")?>'+id;
        }
