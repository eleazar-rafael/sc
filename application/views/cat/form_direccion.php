<?php 
    $cbo_estado = $this->direccion_model->cbo_sepomex_estado("--Seleccione--");
    $cbo_municipio = $this->direccion_model->cbo_sepomex_municipio((int)$direccion['estado'], "--Seleccione--");
    $cbo_colonia = $this->direccion_model->cbo_sepomex_asentamiento((int)$direccion['estado'], (int)$direccion['ciudad_delegacion'], "--Seleccione--");
?>
